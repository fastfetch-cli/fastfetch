...
static const char* detectWifiWithNm(FFWifiResult* item, FFstrbuf* buffer) {
    ...
    if (flagCount == 3) {
        ...
        if ((rsnFlags & NM_802_11_AP_SEC_KEY_MGMT_PSK) || (rsnFlags & NM_802_11_AP_SEC_KEY_MGMT_802_1X)) {
        ...
        if ((rsnFlags & NM_802_11_AP_SEC_KEY_MGMT_OWE) || (rsnFlags & NM_802_11_AP_SEC_KEY_MGMT_OWE_TM)) {
