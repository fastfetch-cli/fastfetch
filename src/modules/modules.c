...
// Note:
// FF_MODULE_<module> only controls if the module is registered,
...
#if FF_MODULE_BATTERY
    &ffBatteryModuleInfo,
#endif
#if FF_MODULE_BIOS
    &ffBiosModuleInfo,
#endif
#if FF_MODULE_BLUETOOTH
    &ffBluetoothModuleInfo,
#endif
#if FF_MODULE_BLUETOOTHRADIO
    &ffBluetoothRadioModuleInfo,
#endif
#if FF_MODULE_BOARD
    &ffBoardModuleInfo,
#endif
#if FF_MODULE_BOOTMGR
    &ffBootmgrModuleInfo,
#endif
#if FF_MODULE_BREAK
    &ffBreakModuleInfo,
#endif
#if FF_MODULE_BRIGHTNESS
...
static FFModuleBaseInfo* C[] = {
    ...
    &ffCameraModuleInfo,
#endif
#if FF_MODULE_CHASSIS
    &ffChassisModuleInfo,
#endif
#if FF_MODULE_COMMAND
    &ffCommandModuleInfo,
#endif
#if FF_MODULE_COLORS
    &ffColorsModuleInfo,
...
#if FF_MODULE_DATETIME
    &ffDateTimeModuleInfo,
#endif
#if FF_MODULE_DE
    &ffDEModuleInfo,
#endif
#if FF_MODULE_DISPLAY
    &ffDisplayModuleInfo,
#endif
#if FF_MODULE_DISK
    &ffDiskModuleInfo,
...
static FFModuleBaseInfo* L[] = {
    ...
    &ffLMModuleInfo,
#endif
#if FF_MODULE_LOADAVG
    &ffLoadavgModuleInfo,
#endif
#if FF_MODULE_LOCALE
    &ffLocaleModuleInfo,
#endif
#if FF_MODULE_LOCALIP
    &ffLocalIPModuleInfo,
#endif
#if FF_MODULE_LOGO
    &ffLogoModuleInfo,
...
#if FF_MODULE_PACKAGES
    &ffPackagesModuleInfo,
#endif
#if FF_MODULE_PHYSICALDISK
    &ffPhysicalDiskModuleInfo,
#endif
#if FF_MODULE_PHYSICALMEMORY
    &ffPhysicalMemoryModuleInfo,
#endif
#if FF_MODULE_PLAYER
    &ffPlayerModuleInfo,
#endif
#if FF_MODULE_POWERADAPTER
    &ffPowerAdapterModuleInfo,
#endif
#if FF_MODULE_PROCESSES
...
#endif
#if FF_MODULE_TERMINALFONT
    &ffTerminalFontModuleInfo,
#endif
#if FF_MODULE_TERMINALSIZE
    &ffTerminalSizeModuleInfo,
#endif
#if FF_MODULE_TERMINALTHEME
